...
Usage:
    python JESTER/utils/upload_to_hub.py               # build combined JSONL + upload
    python JESTER/utils/upload_to_hub.py --build-only  # build combined JSONL, skip upload
    python JESTER/utils/upload_to_hub.py --repo MyOrg/my-dataset
