...
Usage:
    python V3/scripts/write_resume.py --benchmark adversarial_code_buggy --output Resume_adversarial_code_buggy.txt
    python V3/scripts/write_resume.py --benchmark cubert_wbo --output Resume_cubert.txt
    python V3/scripts/write_resume.py --benchmark adversarial_code_buggy --logs-dir logs --output Resume.txt
"""
