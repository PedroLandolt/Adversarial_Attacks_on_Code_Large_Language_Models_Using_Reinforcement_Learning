...
Usage (build dataset — run once):
    python V3/utils/pregenerate_buggy_code.py               # both benchmarks, all samples
    python V3/utils/pregenerate_buggy_code.py --benchmark mbpp --limit 10   # smoke test
    python V3/utils/pregenerate_buggy_code.py --benchmark humaneval
    python V3/utils/pregenerate_buggy_code.py --model llama3.2:3b
...
# ---------------------------------------------------------------------------
# Path setup — add V3/ to sys.path so utils.* imports work when running directly
# ---------------------------------------------------------------------------
